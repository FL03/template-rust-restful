...
pub type AxumServer = axum::Server<hyper::server::conn::AddrIncoming, axum::routing::IntoMakeService<axum::Router>>;
...
impl Interface {
    pub async fn new() -> Self {
        ...
        axum::Server::bind(&address)
            .serve(client.into_make_service()).await.expect("Server Error");
